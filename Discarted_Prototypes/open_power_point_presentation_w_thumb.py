...
def main():
    ...
    while True:
       ...
       # }
        ...
        def state_machine():
            global thumb_up,thumb_down,palm_stop,peace_right,peace_left,rock_left,rock_right,shotgun_right,shotgun_left,to_break
            if thumb_up == True:
                ...
                os.startfile(r"C:\Users\Admin\OneDrive\Documents\Slide_shoow_presentation.pptx")
            elif palm_stop == True:
                    to_break = True
            return()
