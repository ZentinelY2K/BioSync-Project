...
def main():
    ...
    while True:
       ...
       # }
        ...
        def scroll(up=False,down=False):
            if up:
               pyautogui.scroll(3)
            elif down:
               pyautogui.scroll(-3)
        ...
        def shotGun_leftMost():
           ...
           # ratio_thumb_tip_ring = non_zero_div(tip_of_thumb_y, middle_of_ring)
            ...
            print(ratio_shotgun_palm,ratio_shotGunPalm_indexKnuckle,ratio_index_tip_middle_tip,ratio_thumb_tip_to_middle,palm_x)
            ...
            elif ratio_shotgun_palm <= -0.20 and ratio_shotGunPalm_indexKnuckle <=  -0.15 and palm_x <= 960 and ratio_index_tip_middle_tip >= 1.80 and ratio_thumb_tip_to_middle >= 1.10:
                shotgun_left = True
        ...
        def mouse_logic():
            ...
            tip_of_thumb = landmarkList[fingers['Thumb']['Tip']][2]
            tip_of_pinky = landmarkList[fingers['Pinky']['Tip']][2]
            ...
            print(distance_ThumbTip_to_IndexKnuckle) 

            if previous_x == index_finger_tracing_x and previous_y == index_finger_tracing_y:
                pass
            else:
                pyautogui.moveTo(index_finger_tracing_x,index_finger_tracing_y)
            
            if distance_ThumbTip_to_IndexKnuckle <= -230:
                pyautogui.leftClick()
            else:
                pass
